...
<div class="container">
    <div class="row">
        <div class="col-md-4">
            <div class="card">
                <img src="https://beptruong.edu.vn/wp-content/uploads/2013/05/mon-ha-cao-tom-thit.jpg" alt="Há cảo tôm"class="card-img-top"/>
                <div class="card-body">
                    ...
                    <a href="main/scr_hap1.php" class="btn btn-primary">View Recipe</a>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card">
                <img src="https://dashilabvn.com/wp-content/uploads/2022/01/SIZE-HINH-WEB-30.png" alt="Cơm hấp kiểu Nhật" class="card-img-top"/>                
                <div class="card-body">
                    ...
                    <a href="main/scr_hap2.php" class="btn btn-primary">View Recipe</a>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card">
                <img src="https://dacsanbac.com.vn/wp-content/uploads/2024/02/kiotviet_29807711be9a62f48b2eea5b760b7bfd.jpeg" alt="Chả giò ngũ sắc"  class="card-img-top"/>
                <div class="card-body">
                    ...
                    <a href="main/scr_hap3.php" class="btn btn-primary">View Recipe</a>
                </div>
            </div>
        </div>
    </div>
