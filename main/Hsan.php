...
<head>
    ...
    <link rel="stylesheet" href="../css/Hsan.css">
</head>
...
<div class="container">
    <div class="row">
        <div class="col-md-4">
            <div class="card">
                <img src="https://statics.vinwonders.com/banh-da-cua-hai-phong-o-ha-noi-1_1687012182.jpg" alt="bánh đa cua" class="card-img-top"/>
                <div class="card-body">
                    ...
                    <a href="main/hsan1.php" class="btn btn-primary">View Recipe</a>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card">
                <img src="https://static.vinwonders.com/production/bun-oc-nguoi-ha-noi-1.jpg" alt="bún ốc nguội" class="card-img-top"/>                
                <div class="card-body">
                    ...
                    <a href="main/hsan2.php" class="btn btn-primary">View Recipe</a>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card">
                <img src="https://syphu.com.vn/wp-content/uploads/2022/11/lam-lau-cua-dong.jpg" alt="Lẩu riêu cua"  class="card-img-top"/>
                <div class="card-body">
                    ...
                    <a href="main/hsan3.php" class="btn btn-primary">View Recipe</a>
                </div>
            </div>
        </div>
    </div>
