...
<div class="container">
    <div class="row">
        <div class="col-md-4">
            <div class="card">
                <img src="https://minhha.com.vn/statics/endusers/upload/images/Cong%20thuc%20nau%20an/unnamed-6.jpg" alt="bắp bò ngâm mắm" class="card-img-top"/>
                <div class="card-body">
                    ...
                    <a href="main/scr_thitbo1.php" class="btn btn-primary">View Recipe</a>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card">
                <img src="https://fujifoods.vn/wp-content/uploads/2021/05/bo-ham-nam-3.png" alt="bò hầm kiểu pháp" class="card-img-top"/>                
                <div class="card-body">
                    ...
                    <a href="main/scr_thitbo2.php" class="btn btn-primary">View Recipe</a>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card">
                <img src="https://static.vinwonders.com/production/bo-kho-nha-trang-1.jpg" alt="Bò kho" class="card-img-top"/>
                <div class="card-body">
                    ...
                    <a href="main/scr_thitbo3.php" class="btn btn-primary">View Recipe</a>
                </div>
            </div>
        </div>
    </div>
