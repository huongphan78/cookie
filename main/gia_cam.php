...
<head>
    ...
    <link rel="stylesheet" href="../css/gia_cam.css">
</head>
...
<div class="container">
    <div class="row">
        <div class="col-md-4">
            <div class="card">
                <img src="https://i.ytimg.com/vi/aScvYvQCadg/maxresdefault.jpg" alt="cánh gà nướng cay kiểu Hàn" class="card-img-top"/>
                <div class="card-body">
                    ...
                    <a href="main/gia_cam1.php" class="btn btn-primary">View Recipe</a>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card">
                <img src="https://heoquaydachoa.com/wp-content/uploads/2022/12/Vit-Quay-Mat-Ong-Dac-Hoa-1200x900-1.jpg" alt="vịt quay" class="card-img-top"/>                
                <div class="card-body">
                    ...
                    <a href="main/gia_cam2.php" class="btn btn-primary">View Recipe</a>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card">
                <img src="https://daotaobeptruong.vn/wp-content/uploads/2020/11/ga-xao-hung-que.jpg" alt="mề gà xào" class="card-img-top"/>
                <div class="card-body">
                    ...
                    <a href="main/gia_cam3.php" class="btn btn-primary">View Recipe</a>
                </div>
            </div>
        </div>
    </div>
