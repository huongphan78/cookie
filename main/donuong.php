        ...
        <div class="col-md-4">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a href="main/scr_nuong1.php" class="btn btn-primary">View Recipe</a>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a href="main/scr_nuong2.php" class="btn btn-primary">View Recipe</a>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a href="main/scr_nuong3.php" class="btn btn-primary">View Recipe</a>
                </div>
            </div>
        </div>
    </div>
